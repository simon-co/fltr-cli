...
void _appSettingsSerialize(
  ...
  writer.writeString(offsets[0], object.theme?.name);
}
...
AppSettings _appSettingsDeserialize(
  ...
  object.id = id;
  object.theme =
      _AppSettingsthemeValueEnumMap[reader.readStringOrNull(offsets[0])];
  return object;
}
...
extension AppSettingsQueryFilter
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterFilterCondition> themeIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'theme',
      ));
...
extension AppSettingsQueryProperty
  ...
  QueryBuilder<AppSettings, ThemeMode?, QQueryOperations> themeProperty() {
    return QueryBuilder.apply(this, (query) {
